...
RG353V2:
	DEVICE_ROOT=RG503 PROJECT=Rockchip DEVICE=RG353V2 ARCH=arm ./scripts/build_distro
	DEVICE_ROOT=RG503 PROJECT=Rockchip DEVICE=RG353V2 ARCH=aarch64 ./scripts/build_distro
